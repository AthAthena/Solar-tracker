...
//    Serial.print(" qz = "); Serial.println(q[3]); 
  ...
  // For more see http://en.wikipedia.org/wiki/Conversion_between_quaternions_and_Euler_angles which has additional links.
    ...
    pitch *= 180.0f / PI;
    yaw   *= 180.0f / PI; 
    yaw   += 4.52;     /* Latitude:   35.5224° N
Longitude:  24.121289° E STERNES
Date  Declination
2020-02-04  4.52° E  ± 0.33°  changing by  0.10° E per year 

//OR IN KASTELI    yaw   += 4.47; Latitude:   35.493223° N
Longitude:  23.654866° E
Date  Declination
2020-02-04  4.47° E  ± 0.33°  changing by  0.10° E per year */
